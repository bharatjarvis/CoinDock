    ...
    ->group(function () {
        Route::prefix('{user}')->group(function () {
            ...
            Route::prefix('graph')->group(function () {
                ...
                Route::get('/real-time-graph/display', [WalletCoinController::class, 'showCoinRangeData']);
                Route::get('/real-time-graph/coins-history', [WalletCoinController::class, 'realtimeCoinHistoricalData']);
